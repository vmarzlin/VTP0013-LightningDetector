...
class AS3935
{
  public:
    ...
    // SPI begin
    bool begin(uint8_t user_CSPin, uint32_t spiPortSpeed = 1000000);
    ...
    void displayOscillator(uint8_t _osc);
    ...
    void writeRegister(uint8_t _reg, uint8_t _value);
  ...
  private:
    ...
    // This function handles all SPI write commands. It takes the register to write
